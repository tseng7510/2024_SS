              ...
              <div class="content wow fadeInUp" data-wow-delay="0s">
                <div class="container">
                  <div class="editor detail">
                    ...
                    <ul class="list">
                      <li>Pressure: ≤ 350 Bar</li>
                      <li>Sliding speed: ≤ 15 m/s</li>
                      <li>Temperature: -150°C ~ 225°C</li>
                    </ul>
                    <hr>
                    <div class="subTitle">Common Applications</div>
                    <div class="listBox">
                      <div class="item">
                        <div class="pic"><img src="../images/in/products_icon1.svg" alt=""></div>
                        <p>Automotive seals</p>
                      </div>
                      <div class="item">
                        <div class="pic"><img src="../images/in/products_icon2.svg" alt=""></div>
                        <p>Pharma and healthcare</p>
                      </div>
                      <div class="item">
                        <div class="pic"><img src="../images/in/products_icon3.svg" alt=""></div>
                        <p>Water and Sanitary seals</p>
                      </div>
                      <div class="item">
                        <div class="pic"><img src="../images/in/products_icon4.svg" alt=""></div>
                        <p>Motorcycle</p>
                      </div>
                      <div class="item">
                        <div class="pic"><img src="../images/in/products_icon5.svg" alt=""></div>
                        <p>Hydraulic and pneumatic</p>
                      </div>
                      <div class="item">
                        <div class="pic"><img src="../images/in/products_icon6.svg" alt=""></div>
                        <p>Food and Beverage</p>
                      </div>
                      <div class="item">
                        <div class="pic"><img src="../images/in/products_icon7.svg" alt=""></div>
                        <p>Custom parts</p>
                      </div>
                      <div class="item">
                        <div class="pic"><img src="../images/in/products_icon8.svg" alt=""></div>
                        <p>Wind power and energy</p>
                      </div>
                    </div>
                  </div>
                </div>
